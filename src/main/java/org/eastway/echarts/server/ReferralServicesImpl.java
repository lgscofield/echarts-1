...
public class ReferralServicesImpl extends RpcServicesImpl implements ReferralServices {
	...
	@Override
	public Referral findByEhr(long ehr, String sessionId) throws SessionExpiredException, DbException {
		...
		TypedQuery<ReferralImpl> query = em.createQuery(
				"SELECT r FROM ReferralImpl r where r.ehr = " + ehr, ReferralImpl.class);
