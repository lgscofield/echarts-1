...
public class ReferralColumnDefinitionsImpl extends ArrayList<ColumnDefinition<Referral>> {

	public ReferralColumnDefinitionsImpl() {
		this.add(new ColumnDefinition<Referral>() {
			@Override
			public void render(Referral t, StringBuilder sb) {
				sb.append(t.getTakenByStaff() == null ? "" : t.getTakenByStaff());
			}

			@Override
			public String getHeader(Referral t) {
				return "<b>Taken&nbsp;by</b>";
			}
		});
		this.add(new ColumnDefinition<Referral>() {
