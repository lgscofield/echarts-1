...
public class AppointmentColumnDefinitionsImpl extends ArrayList<ColumnDefinition<Appointment>>{

	public AppointmentColumnDefinitionsImpl() {
		this.add(new ColumnDefinition<Appointment>() {
			@Override
			public void render(Appointment t, StringBuilder sb) {
				sb.append(t.getActivity() == null ? "" : t.getActivity());
			}

			@Override
			public String getHeader(Appointment t) {
				return "<b>Activity</b>";
			}
		});
		this.add(new ColumnDefinition<Appointment>() {
