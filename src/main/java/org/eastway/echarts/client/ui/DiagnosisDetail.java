...
public class DiagnosisDetail extends Composite {
	...
	@UiField SpanElement provision1A;
	@UiField SpanElement axis1B;
	@UiField SpanElement provision1B;
	@UiField SpanElement axis1C;
	@UiField SpanElement provision1C;
	@UiField SpanElement axis1D;
	@UiField SpanElement provision1D;
	@UiField SpanElement axis1E;
	@UiField SpanElement provision1E;
	@UiField SpanElement axis2A;
	@UiField SpanElement provision2A;
	@UiField SpanElement axis2B;
	@UiField SpanElement provision2B;
	@UiField SpanElement axis2C;
	@UiField SpanElement provision2C;
