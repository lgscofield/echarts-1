 ...
 */
public class EchartsNotificationMole extends Composite {
  /**
  ...
  interface Binder extends UiBinder<HTMLPanel, EchartsNotificationMole> {
  }
  ...
  public EchartsNotificationMole() {
