...
public class EHRViewImpl<T> extends Composite implements EHRView<T> {
	...
	void onAddressesSelected(ClickEvent event) {
		presenter.viewAddresses();
	}

//	@UiHandler("contacts")
//	void onContatsSelected(ClickEvent event) {
//		presenter.viewContacts();
//	}
